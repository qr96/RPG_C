...
public class MyPlayer : MonoBehaviour
{
    ...
    {
        var cameraDis = RBUtil.CalculateCameraDis((float)Screen.width / Screen.height);
        // standard cameraDis = 16f
    ...
    {
        input.x = Managers.Input.GetInputHorizontal();
        input.y = Managers.Input.GetInputVertical();
